Billing Module is a simple patient billing supporting application written in Ruby on Rails and is intended as a additional program for medical information products from Baobab Health Trust.
